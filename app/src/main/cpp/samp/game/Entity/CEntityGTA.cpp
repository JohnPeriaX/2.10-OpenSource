...
void CEntityGTA::Add()
{
    CHook::CallFunction<void>(g_libGTASA + 0x4CD574, this);
}
...
void CEntityGTA::SetInterior(int interiorId, bool needRefresh)
{
    ...
    if ( this == (CEntityGTA*)pGame->FindPlayerPed()->m_pPed )
    {
        ...
        if(interiorId == 0) {
            CHook::CallFunction<void>(g_libGTASA + 0x504194, false);
...
void CEntityGTA::DeleteRwObject()
{
    ...
    (( void (*)(CEntityGTA*))(*(void**)(*(uintptr*)this + 0x24*2)))(this);
}
...
void CEntityGTA::Add(const CRect* rect) {
    CHook::CallFunction<void>(g_libGTASA + 0x4CD5C0, this, rect);
}

void CEntityGTA::Remove() {
    CHook::CallFunction<void>(g_libGTASA + 0x4CD888, this);
}
