...
//    pos.Set(x, y, z);
    (( void (*)(CPlaceable*, float, float, float, bool))(*(void**)(*(uintptr*)this + 0x3C*2)))(this, x, y, z, 0);
}

void CPlaceable::SetPosn(const CVector& posn) {
//    auto& pos = GetPosition();
//    pos = posn;
    (( void (*)(CPlaceable*, float, float, float, bool))(*(void**)(*(uintptr*)this + 0x3C*2)))(this, posn.x, posn.y, posn.z, 0);
}
