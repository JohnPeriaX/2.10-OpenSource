...
void CPedIntelligence::FlushIntelligence() {
    CHook::CallFunction<void>(g_libGTASA + 0x5BE0E0, this);
//    m_TaskMgr.Flush();
...
void CPedIntelligence::FlushImmediately(bool bSetPrimaryDefaultTask) {
    CHook::CallFunction<void>(g_libGTASA + 0x5BD2D0, this, bSetPrimaryDefaultTask);
...
void CPedIntelligence::ProcessAfterPreRender() {
    CHook::CallFunction<void>(g_libGTASA + 0x5BDC18, this);
}
