...
bool CAnimBlendNode::NextKeyFrame() {
    return CHook::CallFunction<bool> (g_libGTASA + 0x463114, this);
}

// 0x4D0570
bool CAnimBlendNode::NextKeyFrameCompressed() {
    return CHook::CallFunction<bool>(g_libGTASA + 0x463954, this);
}

// 0x4CFB90
bool CAnimBlendNode::NextKeyFrameNoCalc() {
    return CHook::CallFunction<bool>(g_libGTASA + 0x462E90, this);
}
...
bool CAnimBlendNode::Update(CVector& trans, CQuaternion& rot, float weight) {
    return CHook::CallFunction<bool>(g_libGTASA + 0x462F74, this, trans, rot, weight);
}

// 0x4D08D0
bool CAnimBlendNode::UpdateCompressed(CVector& trans, CQuaternion& rot, float weight) {
    return CHook::CallFunction<bool>(g_libGTASA + 0x4636D0, this, trans, rot, weight);
}
