...
//    m_nGroupID = 0xFFFFFFFF;
    CHook::CallFunction<void>(g_libGTASA + 0x460C28, this);
...
CAnimBlendAssociation* CAnimBlendAssocGroup::CopyAnimation(const char* AnimName) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x4615E8, this, AnimName);
}

// 0x4CE130
CAnimBlendAssociation* CAnimBlendAssocGroup::CopyAnimation(uint32 ID) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x461670, this, ID);
}

// 0x4CE220
void CAnimBlendAssocGroup::CreateAssociations(const char* szBlockName) {
    return CHook::CallFunction<void>(g_libGTASA + 0x460DE0, szBlockName);
}

// 0x4CE6E0
void CAnimBlendAssocGroup::CreateAssociations(const char* AnimName, RpClump* clump, char** arg3, int32 NumAnimations) {
    CHook::CallFunction<void>(g_libGTASA + 0x461380, this, AnimName, clump, arg3, NumAnimations);
}

// 0x4CE3B0
void CAnimBlendAssocGroup::CreateAssociations(const char* AnimName, const char* arg2, const char* arg3, uint32 strStorageSz) {
    CHook::CallFunction<void>(g_libGTASA + 0x460FAC, this, AnimName, arg2, arg3, strStorageSz);
}

// 0x4CDFF0
void CAnimBlendAssocGroup::DestroyAssociations() {
    CHook::CallFunction<void>(g_libGTASA + 0x460C9C, this);
}

CAnimBlendStaticAssociation* CAnimBlendAssocGroup::GetAnimation(const char* AnimName) {
    return CHook::CallFunction<CAnimBlendStaticAssociation*>(g_libGTASA + 0x461574, this, AnimName);
}
...
uint32 CAnimBlendAssocGroup::GetAnimationId(const char* AnimName) {
    return CHook::CallFunction<uint32>(g_libGTASA + 0x4616C4, this, AnimName);
}

// 0x4CDFB0
void CAnimBlendAssocGroup::InitEmptyAssociations(RpClump* clump) {
    CHook::CallFunction<void>(g_libGTASA + 0x461508, this, clump);
}

// 0x4CE1D0
CAnimBlendAssocGroup::~CAnimBlendAssocGroup() {
    CHook::CallFunction<void>(g_libGTASA + 0x460C3C, this);
}
