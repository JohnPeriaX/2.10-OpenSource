...
void CCollision::InjectHooks() {
    CHook::Write(g_libGTASA + 0x84D540, &ms_colModelCache);
    CHook::Write(g_libGTASA + 0x84E7C8, &ms_iProcessLineNumCrossings);
    CHook::Write(g_libGTASA + 0x84C7C0, &ms_collisionInMemory);

    CHook::Write(g_libGTASA + 0x84FB18, &bCamCollideWithVehicles);
