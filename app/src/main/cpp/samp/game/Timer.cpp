...
{
    CHook::Write(g_libGTASA + 0x8509A0, &CTimer::m_CodePause);
    CHook::Write(g_libGTASA + 0x84F280, &CTimer::m_FrameCounter);
    CHook::Write(g_libGTASA + 0x84CD28, &CTimer::game_FPS);
    CHook::Write(g_libGTASA + 0x84CD90, &CTimer::m_UserPause);
    CHook::Write(g_libGTASA + 0x84B1A8, &CTimer::ms_fTimeScale);
    CHook::Write(g_libGTASA + 0x84C030, &CTimer::m_snTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x8504B8, &CTimer::bSkipProcessThisFrame);
    CHook::Write(g_libGTASA + 0x84CE50, &CTimer::ms_fTimeStep);

    CHook::Write(g_libGTASA + 0x850960, &CTimer::m_snPPPPreviousTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x84DC10, &CTimer::m_snPPPreviousTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x851A90, &CTimer::m_snPPreviousTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x84D388, &CTimer::m_snPreviousTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x851B90, &CTimer::m_snTimeInMillisecondsNonClipped);
    CHook::Write(g_libGTASA + 0x84CC30, &CTimer::m_snPreviousTimeInMillisecondsNonClipped);

    gTimerRunning = &*(uint8_t*)(g_libGTASA + 0xBDC5AC);
...
{
    return CHook::CallFunction<uint32_t>(g_libGTASA + 0x504858);
}
...
{
    return CHook::CallFunction<uint64_t>(g_libGTASA + 0x504888);
}
