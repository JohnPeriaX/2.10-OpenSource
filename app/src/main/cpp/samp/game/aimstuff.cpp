...
{
    CCamera& origCam = *reinterpret_cast<CCamera*>(g_libGTASA + 0xBBA8D0);
...
void GameAimSyncInit()
{
	...
	pfAspectRatio = (float*)(g_libGTASA + 0xCC7F00);
	pfCameraExtZoom = &TheCamera.m_aCams[0].FOV;
	wCameraMode2 = &TheCamera.PlayerWeaponMode.m_nMode;
	pPlayerStats = (float*)(g_libGTASA+0xBD585C);

	pbyteCurrentPlayer = (uint8_t*)(g_libGTASA + 0xBDCAE8);
}
// 0.3.7
