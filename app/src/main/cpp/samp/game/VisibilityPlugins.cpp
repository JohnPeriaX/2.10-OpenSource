...
void CVisibilityPlugins::Initialise() {
    CHook::CallFunction<void>(g_libGTASA + 0x6F954C);
}

void CVisibilityPlugins::SetRenderWareCamera(RwCamera* camera) {
    CHook::CallFunction<void>(g_libGTASA + 0x6FB5BC, camera);
}
...
int32 CVisibilityPlugins::GetClumpAlpha(RpClump* clump) {
    return CHook::CallFunction<int32>(g_libGTASA + 0x6FA290, clump);
}

void CVisibilityPlugins::RenderAlphaAtomic(RpAtomic* atomic, int32 alpha) {
    CHook::CallFunction<void>(g_libGTASA + 0x6FC1A8, atomic, alpha);
}

void CVisibilityPlugins::InjectHooks() {
    //CHook::Write(g_libGTASA + 0x84A480, &CVisibilityPlugins::ms_pedLodDist);
    //CHook::Write(g_libGTASA + 0x84AAD0, &CVisibilityPlugins::ms_pCameraPosn);
}

void CVisibilityPlugins::SetupVehicleVariables(RpClump *clump) {
    CHook::CallFunction<void>(g_libGTASA + 0x6F9DB0, clump);
}

void CVisibilityPlugins::RenderReallyDrawLastObjects() {
    CHook::CallFunction<void>(g_libGTASA + 0x6FC3DC);
}

// The function name is misleading, it returns the flags
uint16 CVisibilityPlugins::GetAtomicId(RpAtomic* atomic) {
    return CHook::CallFunction<uint16>(g_libGTASA + 0x6F9D68, atomic);
}
