...
bool RpAnimBlendPluginAttach() {
    return CHook::CallFunction<bool>(g_libGTASA + 0x46A30C);
}

// 0x4D5FA0
void* RtAnimBlendKeyFrameApply(void* result, void* frame) {
    return CHook::CallFunction<void*>(g_libGTASA + 0x46A1B8, result, frame);
...
CAnimBlendClumpData* RpAnimBlendAllocateData(RpClump* clump) {
    return CHook::CallFunction<CAnimBlendClumpData*>(g_libGTASA + 0x46A17C, clump);
}
...
CAnimBlendAssociation* RpAnimBlendClumpAddAssociation(RpClump* clump, CAnimBlendAssociation* association, uint32 flags, float startTime, float blendAmount) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46A9A0, clump, association, flags, startTime, blendAmount);
}
...
AnimBlendFrameData* RpAnimBlendClumpFindBone(RpClump* clump, uint32 id) {
    return CHook::CallFunction<AnimBlendFrameData*>(g_libGTASA + 0x46A694, clump, id);
}

// 0x4D62A0
AnimBlendFrameData* RpAnimBlendClumpFindFrame(RpClump* clump, const char* name) {
    return CHook::CallFunction<AnimBlendFrameData*>(g_libGTASA + 0x46A4A4, clump, name);
}

// 0x4D6370
AnimBlendFrameData* RpAnimBlendClumpFindFrameFromHashKey(RpClump* clump, uint32 key) {
    return CHook::CallFunction<AnimBlendFrameData*>(g_libGTASA + 0x46A5A0, clump, key);
}
...
CAnimBlendAssociation* RpAnimBlendClumpGetAssociation(RpClump* clump, bool bStopFunctionConfusion, CAnimBlendHierarchy* hierarchy) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46AB7C, clump, bStopFunctionConfusion, hierarchy);
}

// 0x4D6870
CAnimBlendAssociation* RpAnimBlendClumpGetAssociation(RpClump* clump, const char* name) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46AAF4, clump, name);
}

// AnimationId animId
// 0x4D68B0
CAnimBlendAssociation* RpAnimBlendClumpGetAssociation(RpClump* clump, uint32 animId) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46AB48, clump, animId);
}
...
CAnimBlendAssociation* RpAnimBlendClumpGetFirstAssociation(RpClump* clump, uint32 flags) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46AD68, clump, flags);
}
...
CAnimBlendAssociation* RpAnimBlendClumpGetMainAssociation(RpClump* clump, CAnimBlendAssociation** pp2ndAnim, float* pBlendVal2nd) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46ABB0, clump, pp2ndAnim, pBlendVal2nd);
}

// 0x4D6A30
CAnimBlendAssociation* RpAnimBlendClumpGetMainAssociation_N(RpClump* clump, int32 n) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46ACE8, clump, n);
}
...
CAnimBlendAssociation* RpAnimBlendClumpGetMainPartialAssociation(RpClump* clump) {
   // assert("RpAnimBlendClumpGetMainPartialAssociation no x64 ver");
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46AC80, clump);
}

// 0x4D69F0
CAnimBlendAssociation* RpAnimBlendClumpGetMainPartialAssociation_N(RpClump* clump, int32 n) {
    return CHook::CallFunction<CAnimBlendAssociation*>(g_libGTASA + 0x46AD28, clump, n);
}

// 0x4D6B60
uint32 RpAnimBlendClumpGetNumAssociations(RpClump* clump) {
    return CHook::CallFunction<uint32>(g_libGTASA + 0x46AE54, clump);
}

// 0x4D6BB0
uint32 RpAnimBlendClumpGetNumNonPartialAssociations(RpClump* clump) {
    return CHook::CallFunction<uint32>(g_libGTASA + 0x46AEB4, clump);
}

// 0x4D6B80
uint32 RpAnimBlendClumpGetNumPartialAssociations(RpClump* clump) {
    return CHook::CallFunction<uint32>(g_libGTASA + 0x46AE78, clump);
}

// 0x4D6C30
void RpAnimBlendClumpGiveAssociations(RpClump* clump, CAnimBlendAssociation* association) {
    CHook::CallFunction<void>(g_libGTASA + 0x46AF18, clump, association);
}

// 0x4D6720
void RpAnimBlendClumpInit(RpClump* clump) {
    CHook::CallFunction<void>(g_libGTASA + 0x46A7D4, clump);
}
...
//    return result;
   ...
   return CHook::CallFunction<bool>(g_libGTASA + 0x46A974, clump);
}

// 0x4D6B00
void RpAnimBlendClumpPauseAllAnimations(RpClump* clump) {
    CHook::CallFunction<void>(g_libGTASA + 0x46ADF4, clump);
}
