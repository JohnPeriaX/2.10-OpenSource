...
ModelInfoType CBaseModelInfo::GetModelType() {
    return CHook::CallFunction<ModelInfoType>(*(uintptr_t*)(vtable + 0x14*2), this);
}

int32 CBaseModelInfo::GetAnimFileIndex() {
    return CHook::CallFunction<int32>(*(uintptr_t*)(vtable + 0x3C*2), this);
}

void CBaseModelInfo::DeleteRwObject() {
    CHook::CallFunction<void>(*(uintptr_t*)(vtable + 0x24*2), this);
}
