...
void CPickup::GetRidOfObjects() {
    CHook::CallFunction<void>(g_libGTASA + 0x3E4A20, this);
...
void CPickup::GiveUsAPickUpObject(CObjectGta** obj, int32 slotIndex) {
    CHook::CallFunction<void>(g_libGTASA + 0x3E46D4, this, obj, slotIndex);
}
...
void CPickup::Remove() {
    CHook::CallFunction<void>(g_libGTASA + 0x3E427C, this);
}
