...
{
	// GettPoolVehicleRef
	return ((uintptr_t (*)(CVehicleGTA*))(g_libGTASA + 0x575CD8))(pGtaVehicle);
}

CVehicleGTA* GamePool_Vehicle_GetAt(int iID)
{
	// GetPoolVehicle
	return ((CVehicleGTA* (*)(int))(g_libGTASA + 0x575CE8))(iID);
}
...
{
    if (pGtaVehicle) {
        if (*(uintptr*)pGtaVehicle == g_libGTASA + 0x83BB50) {
            return VEHICLE_SUBTYPE_CAR;
        }
        else if (*(uintptr*)pGtaVehicle == g_libGTASA + 0x83C2A0) {
            return VEHICLE_SUBTYPE_BOAT;
        }
        else if (*(uintptr*)pGtaVehicle == g_libGTASA + 0x83BE40) {
            return VEHICLE_SUBTYPE_BIKE;
        }
        else if (*(uintptr*)pGtaVehicle == g_libGTASA + 0x83C968) {
            return VEHICLE_SUBTYPE_PLANE;
        }
        else if (*(uintptr*)pGtaVehicle == g_libGTASA + 0x83C4C8) {
            return VEHICLE_SUBTYPE_HELI;
        }
        else if (*(uintptr*)pGtaVehicle == g_libGTASA + 0x83C070) {
            return VEHICLE_SUBTYPE_PUSHBIKE;
        }
        else if (*(uintptr*)pGtaVehicle == g_libGTASA + 0x83D058) {
...
void DrawTextureUV(uintptr_t texture, CRect* rect, uint32_t dwColor, float *uv)
{
	if (texture)
	{
		...
		((void(*)(uintptr_t, CRect*, uint32_t*, float, float, float, float, float, float, float, float))
			(g_libGTASA + 0x6EDC5C))(texture, rect, &dwColor, uv[0], uv[1], uv[2], uv[3], uv[4], uv[5], uv[6], uv[7]);
	}
}
...
RwObject* ModelInfoCreateInstance(int iModel)
{
    ...
    if (modelInfo)
    {
        return ((RwObject*(*)(CBaseModelInfo*))(*(uintptr_t*)(modelInfo->vtable + 0x2C*2)))(modelInfo);
    }
...
void RenderClumpOrAtomic(uintptr_t rwObject)
{
    if (rwObject)
    {
        ...
        {
            // rpClumpRender
            ((void (*)(uintptr_t))(g_libGTASA + 0x2BA6A4)) (rwObject);
        }
    }
}
...
void GamePrepareTrain(CVehicleGTA* pGtaVehicle)
{
	...
	if (pDriver)
	{
		if (pDriver->m_nPedType != (ePedType)0 && pDriver->m_nPedType != (ePedType)1)
		{
            ...
            ((void (*)(uintptr_t))(g_libGTASA + 0x5CDC64))((uintptr_t)pDriver);
...
{
	((void (*) (RwMatrix*, RwV3d*, float, int))(g_libGTASA + 0x27E710))(mat, &_axis[axis], angle, 1);
}
// 0.3.7
...
{
	// CWorld::LineOfSight
	return (( int (*)(RwV3d*, RwV3d*, void*, uintptr_t, char, char, char, char, char, char, char, char))(g_libGTASA+0x508C7C))(start, end, colpoint, ent, buildings, vehicles, peds, objects, dummies, seeThrough, camera, unk);
}
...
{
    return ((void (*)(void*))(g_libGTASA + 0x373290))(pRect);
}
...
bool IsValidGamePed(CPedGTA* pPed)
{
    ...
    if (((bool (*)(CPedGTA*))(g_libGTASA + 0x59DE5C))(pPed)) {
        return true;
    }
    return false;
}
...
void RenderEntity(CEntityGTA* entity)
{
    ...
    // CEntity::PreRender
    ((void (*)(CEntityGTA*))(*(uintptr_t*)( *(uintptr*)(entity) + 0x48*2 )))(entity);

    // CRenderer::RenderOneNonRoad
    (( void (*)(CEntityGTA*))(g_libGTASA + 0x4F56E0))(entity);
}